...
<br/>
The frontend will be accessed by users through the internet, and the backend will be accessed exxlusively by the frontend. Configure your Security Groups as such.
<br/>
<br/>
### Backend Setup
#### Download Git
